...
if ( bbp_topics() ) : ?>
    ...
    <?php // Paginación arriba (opcional)
    ...
    <?php while ( bbp_topics() ) : bbp_the_topic();
        ...
        $excerpt = wp_trim_words( $plain, 24, '...' );
        ...
        ?>
        <div class="row forum-item" style="position:relative;margin:0 0 5px 0;">
            ...
            <div class="col-md" style="margin-bottom:20px">
                ...
                <p class="last-reply" style="margin:0 0 8px;color:#6a6e83;">
                ...
                <?php if ( ! empty( $tags ) ) : ?>
                    <div class="tag-container row" style="gap:8px;margin-top:6px;">
                        <?php foreach ( $tags as $t ) :
                            ...
                            <a class="tag-card col-auto" href="<?php echo esc_url( $link ); ?>"
                               style="display:inline-block;background:#eef2ff;color:#3730a3;border-radius:999px;padding:4px 10px;font-size:12px;text-decoration:none;">
            ...
            <!-- Derecha -->
            <div class="col-md-auto text-end" style="min-width:160px;">
                ...
                <div>
                    <p style="margin:0;color:#6a6e83;"><i class="bi bi-chat"></i> <?php echo number_format_i18n( $replies ); ?></p>
                </div>
...
<?php endif; ?>
            ...
            <p style="position:absolute;bottom:10px;right:0;text-align:end;font-size:14px;padding-right:20px;color:#6a6e83;margin:0;">
