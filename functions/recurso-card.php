<?php
function mostrar_tarjetas_recursos($cantidad = -1, $filtrar_tipo = '', $columnas = 12, $mostrar_contenido = true) {
    $meta_query = array();
    ...
    if ($query->have_posts()) {
        while ($query->have_posts()) {
            ...
            echo '<div class="col-'. esc_attr($columnas) .'" style="height: 100%;position: relative;">';
            ...
            // Mostrar contenido solo si $mostrar_contenido es true
